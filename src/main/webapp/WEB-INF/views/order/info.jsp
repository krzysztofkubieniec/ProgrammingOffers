...
<div class="container">
    <div class="row">
        <div class="mx-auto p-5 my-3 text-center bg-light rounded-custom">
            <div class="rounded-custom w-75 mx-auto">
                <h3>${order.title}</h3>
                <div class="row">
                    <div class="text-left col-9 px-5">
                ...
                <div class="container">
                    <div class="row">
                        <div class="details-bg text-left col-8 px-5">
                            <div>
                                Kategorie:
                        ...
                        <div class="col-4 rounded-custom mx-auto bg-light border">
